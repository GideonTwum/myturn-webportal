/**
 * Joins 22 test users via POST /api/groups/join (no direct DB writes).
 * Invite: MT-9TT4
 * Usage: node scripts/join-mt-9tt4-22.mjs
 */
...
const INVITE = "MT-9TT4";
const PASSWORD = process.env.JOIN_TEST_PASSWORD ?? "TestJoin123!";

const MEMBERS = [
  { fullName: "Kwame Asante", phone: "0240002001", email: "user1@test.local" },
  { fullName: "Ama Mensah", phone: "0240002002", email: "user2@test.local" },
  { fullName: "Kojo Boateng", phone: "0240002003", email: "user3@test.local" },
  { fullName: "Abena Owusu", phone: "0240002004", email: "user4@test.local" },
  { fullName: "Kofi Adu", phone: "0240002005", email: "user5@test.local" },
  { fullName: "Yaa Serwaa", phone: "0240002006", email: "user6@test.local" },
  { fullName: "Daniel Ofori", phone: "0240002007", email: "user7@test.local" },
  { fullName: "Akosua Agyeman", phone: "0240002008", email: "user8@test.local" },
  { fullName: "Nana Kwarteng", phone: "0240002009", email: "user9@test.local" },
  { fullName: "Efua Nyarko", phone: "0240002010", email: "user10@test.local" },
  {
    fullName: "Michael Tetteh",
    phone: "0240002011",
    email: "user11@test.local",
  },
  {
    fullName: "Lydia Amponsah",
    phone: "0240002012",
    email: "user12@test.local",
  },
  { fullName: "Isaac Darko", phone: "0240002013", email: "user13@test.local" },
  {
    fullName: "Anita Frimpong",
    phone: "0240002014",
    email: "user14@test.local",
  },
  {
    fullName: "Bright Opoku",
    phone: "0240002015",
    email: "user15@test.local",
  },
  { fullName: "Samuel Addo", phone: "0240002016", email: "user16@test.local" },
  {
    fullName: "Gloria Appiah",
    phone: "0240002017",
    email: "user17@test.local",
  },
  {
    fullName: "Patrick Owusu",
    phone: "0240002018",
    email: "user18@test.local",
  },
  {
    fullName: "Mercy Boateng",
    phone: "0240002019",
    email: "user19@test.local",
  },
  { fullName: "Felix Mensah", phone: "0240002020", email: "user20@test.local" },
  { fullName: "Rita Osei", phone: "0240002021", email: "user21@test.local" },
  { fullName: "Kelvin Amoah", phone: "0240002022", email: "user22@test.local" },
];
